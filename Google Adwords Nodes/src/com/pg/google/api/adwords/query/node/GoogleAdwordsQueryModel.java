...
public class GoogleAdwordsQueryModel extends NodeModel {
    ...
    protected PortObject[] execute(PortObject[] inObjects, ExecutionContext exec) throws Exception {
    	...
    	if ( reportArguments == null ) {
    		com.google.api.ads.adwords.axis.v201806.cm.ReportDefinitionReportType rt = com.google.api.ads.adwords.axis.v201806.cm.ReportDefinitionReportType.fromString(m_config.getReportTypeName());
